...
var wordeasy = [
    ...
    ["Java", "Runs on 15 billion devices.\nA program can be run in Windows, Linux and Mac"],
    ["Love", "What is ?\nBaby don't hurt me\nDon't hurt me\nNo more"],
    ["Run", "Not walk, but"],
    ["Code", "var hw = 'Hello World';"],
    ["Star", "Super Mario likes to get."],
    ["Clock", "helps tell time"],
    ["Sword", "A medieval weapon"],
    ["Girl", "Not boy but ?"],
    ["Boy", "Not girl but ?"],
    ["Female", "Other name for girl."],
    ["Male", "Other name for boy."]
]
var wordmedium = [
    ["Hangman", "The game you are playing right now."],
    ["JavaScript", "Makes a web-page dynamic without reloading the page."],
    ["Document", "A large text file."],
    ["Playground", "where kids play during the school day."],
    ["Samsung", "One of the biggest tech companies in the world."],
    ["Smartphone", "Something you always have on you."]
]
var wordhard = [
    ["Super Mario", "A very popular game on the Nintendo 64. Little dude with a red hat."],
    ["Binary Clock", "A clock that  can only use 0s or 1s."],
]
...
function gameEnd(e) {
    ...
    if (e) {
        ...
        gId("rM").innerHTML = "Congratulations, you got the word!<br/><br/>Good Job!"
    } else {
